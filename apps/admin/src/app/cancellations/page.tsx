...
export default function AdminCancellationsPage() {
  ...
  const updateStatus = async (
    ...
    try {
      await apiJson(
        `/cancellations/${record.id}/status`,
        {
          method: "PATCH",
          ...
          <div className="space-y-3">
            ...
            <div>
              ...
              <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-600">
                Review cancellation requests, coordinate stock restoration, and
                close the workflow with a clear audit trail.
              </p>
            </div>
          </div>
        </section>
              ...
              <div className="space-y-5 bg-slate-50 p-6">
                ...
                <div className="rounded-[1.75rem] border border-slate-200 bg-white p-5 shadow-sm">
                  ...
                  <div className="mt-4 text-sm text-slate-500">
                    Use the status selector to move the request through its workflow without cluttering the action area.
                  </div>
                </div>
              </div>
            </div>
