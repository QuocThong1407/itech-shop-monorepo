...
export default function ResetPasswordForm() {
  ...
  useEffect(() => {
    // Supabase gửi token qua hash fragment (#access_token=...) hoặc query param
        ...
        <section className="flex w-full items-center justify-center p-6 sm:p-10 lg:w-7/12">
          <div className="w-full max-w-lg">
            <div className="rounded-[1.75rem] border border-zinc-200/80 bg-white p-6 shadow-[0_20px_70px_rgba(15,23,42,0.08)] sm:p-8">
              <div className="mb-8">
                <Badge tone="neutral">Đặt lại mật khẩu</Badge>
              ...
              {!token && !success ? (
                ...
                <div className="flex flex-col items-center gap-4 py-8 text-center">
                  ...
                  <p className="max-w-sm text-sm text-zinc-500">
                    Mật khẩu của bạn đã được cập nhật. Đăng nhập để tiếp tục mua
                    sắm.
                  </p>
                  <Link
                    href="/login"
