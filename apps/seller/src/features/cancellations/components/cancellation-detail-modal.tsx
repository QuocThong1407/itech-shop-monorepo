...
export default function CancellationDetailModal({
  ...
  return (
    <ModalShell
      open={open}
      eyebrow="Seller cancellations"
      title={
        selectedRecord
          ? `Cancellation #${selectedRecord.id.slice(0, 10).toUpperCase()}`
          : "Cancellation detail"
      }
      subtitle="Review request details, linked order information, and cancelled line items."
      onClose={onClose}
          ...
          <div className="space-y-5 bg-slate-50 p-6">
            ...
            <DetailSection title="Seller actions" className="shadow-sm">
              <div className="mt-4 text-sm text-slate-500">
                Use the status selector to keep the cancellation workflow consistent with your
                seller operations.
              </div>
            </DetailSection>
          </div>
