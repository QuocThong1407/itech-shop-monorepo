...
export default function OrderDetailModal({
  ...
  return (
    <ModalShell
      ...
      title={selectedOrder ? `Order #${selectedOrder.id.slice(0, 8).toUpperCase()}` : "Order detail"}
            ...
            <DetailSection title="Customer information" className="shadow-sm">
              <KeyValueGrid
                items={[
                  ...
                  { label: "Delivery address", value: selectedAddress || "No address" },
          ...
          <div className="space-y-5 bg-slate-50 p-6">
                        ...
                        <div className="flex items-start gap-4">
                          ...
                          <div className="min-w-0 flex-1">
                            ...
                            <div className="mt-2 flex flex-wrap gap-2 text-xs text-slate-500">
                              ...
                              <span>Adj. {formatMoney(item.ProductVariant?.priceAdjustment || 0)}</span>
                            </div>
                          </div>
                        </div>
                      </div>
            ...
            <DetailSection title="Seller actions" className="shadow-sm">
              <div className="mt-4 text-sm text-slate-500">
                Update fulfillment status from the selector to keep seller operations aligned with
